...
seq:connect("jass:in")
seq:insert(0.0, jiss.lua_event("for i = 1,2 do e:at(0):midi_note_on_(0, stella[bar][math.random(#stella[bar])], 64 + math.random()*64) end"))
...
seq2:insert(0.0, jiss.lua_event("for i = 1,4 do e:at(1):midi_note_on_(0, 24 + stella[bar][math.random(#stella[bar])], 64 + math.random()*64) end"))
